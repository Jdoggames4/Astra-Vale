...
# Jump Sound
jump_sound = pygame.mixer.Sound(join("assets", "Music", "jump.mp3"))
...
class Player(pygame.sprite.Sprite):
      COLOR = (255,0,0)
      GRAVITY = 1
      SPRITES = load_sprite_sheets("Character" , "Guy" ,32,32,True)
      ANIMATION_DELAY = 8
...
class Spikes(Object):
    def __init__(self, x, y, width, height):
        ...
        spike_img = pygame.image.load(join("assets", "Traps", "Spike Head", "Idle.png")).convert_alpha()
